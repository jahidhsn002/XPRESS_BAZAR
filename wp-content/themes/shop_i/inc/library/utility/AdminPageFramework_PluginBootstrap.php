 ...
 */
abstract class bellaAdminPageFramework_PluginBootstrap {
    public $sFilePath;
    public $bIsAdmin;
    public $sHookPrefix;
    ...
    protected function _registerClasses() {
        if (!class_exists('bellaAdminPageFramework_RegisterClasses')) {
            return;
        }
        new bellaAdminPageFramework_RegisterClasses($this->getScanningDirs(), array(), $this->getClasses());
    }
