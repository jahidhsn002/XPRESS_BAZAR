 ...
 */
abstract class bellaAdminPageFramework_Form_Model extends bellaAdminPageFramework_Form_Model_Validation {
    ...
    public function _replyToSendFormEmail() {
        ...
        $_oEmail = new bellaAdminPageFramework_FormEmail($_aFormEmail['email_options'], $_aFormEmail['input'], $_aFormEmail['section_id']);
        $_bSent = $_oEmail->send();
        exit;
    }
