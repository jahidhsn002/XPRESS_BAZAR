 ...
 */
abstract class bellaAdminPageFramework_Form_Model_Export extends bellaAdminPageFramework_Form_Model_Import {
    protected function _exportOptions($mData, $sPageSlug, $sTabSlug) {
        $_oExport = new bellaAdminPageFramework_ExportOptions($_POST['__export'], $this->oProp->sClassName);
