 ...
 */
class bellaAdminPageFramework_Property_Page extends bellaAdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $aisOptionKey, $sCapability = 'manage_options', $sTextDomain = 'admin-page-framework') {
        ...
        $GLOBALS['abellaAdminPageFramework']['aPageClasses'] = isset($GLOBALS['abellaAdminPageFramework']['aPageClasses']) && is_array($GLOBALS['abellaAdminPageFramework']['aPageClasses']) ? $GLOBALS['abellaAdminPageFramework']['aPageClasses'] : array();
        $GLOBALS['abellaAdminPageFramework']['aPageClasses'][$sClassName] = $oCaller;
