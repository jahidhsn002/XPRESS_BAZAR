 ...
 */
abstract class bellaAdminPageFramework_Form_View extends bellaAdminPageFramework_Form_Model {
    ...
    public function _replyToGetFieldOutput($aField) {
        ...
        $_oField = new bellaAdminPageFramework_FormField($aField, $_aTemp, $this->aFieldErrors, $this->oProp->aFieldTypeDefinitions, $this->oMsg, $this->oProp->aFieldCallbacks);
