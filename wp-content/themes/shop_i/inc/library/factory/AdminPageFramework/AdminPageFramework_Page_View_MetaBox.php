 ...
 */
abstract class bellaAdminPageFramework_Page_View_MetaBox extends bellaAdminPageFramework_Page_Model {
    ...
    private function _isMetaBoxAdded($sPageSlug = '') {
        if (!isset($GLOBALS['abellaAdminPageFramework']['aMetaBoxForPagesClasses']) || !is_array($GLOBALS['abellaAdminPageFramework']['aMetaBoxForPagesClasses'])) {
            return false;
        }
        ...
        foreach ($GLOBALS['abellaAdminPageFramework']['aMetaBoxForPagesClasses'] as $sClassName => $oMetaBox) {
    ...
    public function _replyToAddMetaboxScript() {
        if (isset($GLOBALS['abellaAdminPageFramework']['bAddedMetaBoxScript']) && $GLOBALS['abellaAdminPageFramework']['bAddedMetaBoxScript']) {
            return;
        }
        $GLOBALS['abellaAdminPageFramework']['bAddedMetaBoxScript'] = true;
