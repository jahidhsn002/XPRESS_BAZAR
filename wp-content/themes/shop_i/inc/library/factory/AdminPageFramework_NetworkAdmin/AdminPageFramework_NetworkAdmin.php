 ...
 */
abstract class bellaAdminPageFramework_NetworkAdmin extends bellaAdminPageFramework {
    ...
    public function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_network', $sTextDomain = 'admin-page-framework') {
        ...
        $sCallerPath = $sCallerPath ? $sCallerPath : bellaAdminPageFramework_Utility::getCallerScriptPath(__FILE__);
        $this->oProp = new bellaAdminPageFramework_Property_NetworkAdmin($this, $sCallerPath, get_class($this), $sOptionKey, $sCapability, $sTextDomain);
    ...
    static public function getOption($sOptionKey, $asKey = null, $vDefault = null) {
        return bellaAdminPageFramework_WPUtility::getSiteOption($sOptionKey, $asKey, $vDefault);
    }
}