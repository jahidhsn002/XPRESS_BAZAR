 ...
 */
abstract class bellaAdminPageFramework_TaxonomyField_View extends bellaAdminPageFramework_TaxonomyField_Model {
    ...
    private function _getFieldsOutput($iTermID, $bRenderTableRow) {
        ...
        $this->oForm->format();
        $_oFieldsTable = new bellaAdminPageFramework_FormTable($this->oProp->aFieldTypeDefinitions, $this->_getFieldErrors(), $this->oMsg);
