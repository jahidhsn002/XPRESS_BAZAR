 ...
 */
abstract class bellaAdminPageFramework_TaxonomyField extends bellaAdminPageFramework_TaxonomyField_Controller {
    ...
    function __construct($asTaxonomySlug, $sOptionKey = '', $sCapability = 'manage_options', $sTextDomain = 'admin-page-framework') {
        ...
        $this->oProp = new bellaAdminPageFramework_Property_TaxonomyField($this, get_class($this), $sCapability, $sTextDomain, self::$_sFieldsType);
