 ...
 */
class bellaAdminPageFramework_Property_MetaBox_Page extends bellaAdminPageFramework_Property_MetaBox {
    ...
    function __construct($oCaller, $sClassName, $sCapability = 'manage_options', $sTextDomain = 'admin-page-framework', $sFieldsType = 'page_meta_box') {
        ...
        $GLOBALS['abellaAdminPageFramework']['aMetaBoxForPagesClasses'] = isset($GLOBALS['abellaAdminPageFramework']['aMetaBoxForPagesClasses']) && is_array($GLOBALS['abellaAdminPageFramework']['aMetaBoxForPagesClasses']) ? $GLOBALS['abellaAdminPageFramework']['aMetaBoxForPagesClasses'] : array();
        $GLOBALS['abellaAdminPageFramework']['aMetaBoxForPagesClasses'][$sClassName] = $oCaller;
    }
    ...
    private function _getOwnerObjectOfPage($sPageSlug) {
        if (!isset($GLOBALS['abellaAdminPageFramework']['aPageClasses'])) {
            return null;
        }
        if (!is_array($GLOBALS['abellaAdminPageFramework']['aPageClasses'])) {
            return null;
        }
        foreach ($GLOBALS['abellaAdminPageFramework']['aPageClasses'] as $__oClass) {
