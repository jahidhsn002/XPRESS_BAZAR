 ...
 */
abstract class bellaAdminPageFramework_MetaBox_Router extends bellaAdminPageFramework_Factory {
    public function __construct($sMetaBoxID, $sTitle, $asPostTypeOrScreenID = array('post'), $sContext = 'normal', $sPriority = 'default', $sCapability = 'edit_posts', $sTextDomain = 'admin-page-framework') {
        ...
        parent::__construct(isset($this->oProp) ? $this->oProp : new bellaAdminPageFramework_Property_MetaBox($this, $_sClassName, $sCapability));
