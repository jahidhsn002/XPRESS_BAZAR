 ...
 */
abstract class bellaAdminPageFramework_MetaBox extends bellaAdminPageFramework_MetaBox_Controller {
    ...
    function __construct($sMetaBoxID, $sTitle, $asPostTypeOrScreenID = array('post'), $sContext = 'normal', $sPriority = 'default', $sCapability = 'edit_posts', $sTextDomain = 'admin-page-framework') {
        ...
        $this->oProp = new bellaAdminPageFramework_Property_MetaBox($this, get_class($this), $sCapability, $sTextDomain, self::$_sFieldsType);
