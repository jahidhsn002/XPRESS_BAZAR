 ...
 */
abstract class bellaAdminPageFramework_Widget_Model extends bellaAdminPageFramework_Widget_Router {
    ...
    public function _replyToRegisterWidget() {
        ...
        $wp_widget_factory->widgets[$this->oProp->sClassName] = new bellaAdminPageFramework_Widget_Factory($this, $this->oProp->sWidgetTitle, is_array($this->oProp->aWidgetArguments) ? $this->oProp->aWidgetArguments : array());
