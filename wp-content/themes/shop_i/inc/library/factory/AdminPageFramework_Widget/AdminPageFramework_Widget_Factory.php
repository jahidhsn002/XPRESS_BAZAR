 ...
 */
class bellaAdminPageFramework_Widget_Factory extends WP_Widget {
    ...
    public function form($aFormData) {
        ...
        $this->oCaller->oForm = new bellaAdminPageFramework_FormElement($this->oCaller->oProp->sFieldsType, $this->oCaller->oProp->sCapability, $this->oCaller);
    }
