 ...
 */
abstract class bellaAdminPageFramework_UserMeta extends bellaAdminPageFramework_UserMeta_Controller {
    ...
    public function __construct($sCapability = 'edit_user', $sTextDomain = 'admin-page-framework') {
        $this->oProp = new bellaAdminPageFramework_Property_UserMeta($this, get_class($this), $sCapability, $sTextDomain, self::$_sFieldsType);
