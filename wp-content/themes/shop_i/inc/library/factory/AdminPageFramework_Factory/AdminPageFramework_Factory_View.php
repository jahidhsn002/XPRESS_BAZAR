 ...
 */
abstract class bellaAdminPageFramework_Factory_View extends bellaAdminPageFramework_Factory_Model {
    ...
    public function _replyToGetFieldOutput($aField) {
        $_oField = new bellaAdminPageFramework_FormField($aField, $this->oProp->aOptions, $this->_getFieldErrors(), $this->oProp->aFieldTypeDefinitions, $this->oMsg, $this->oProp->aFieldCallbacks);
