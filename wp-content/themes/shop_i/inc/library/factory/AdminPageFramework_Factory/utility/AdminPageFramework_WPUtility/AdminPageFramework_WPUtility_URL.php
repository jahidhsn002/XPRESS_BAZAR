 ...
 */
class bellaAdminPageFramework_WPUtility_URL extends bellaAdminPageFramework_Utility {
    ...
    static public function getQueryAdminURL($aAddingQueries = array(), $aRemovingQueryKeys = array(), $sSubjectURL = '') {
        $_sAdminURL = is_network_admin() ? network_admin_url(bellaAdminPageFramework_WPUtility_Page::getPageNow()) : admin_url(bellaAdminPageFramework_WPUtility_Page::getPageNow());
    ...
    static public function getSRCFromPath($sFilePath) {
        ...
        $sRelativePath = bellaAdminPageFramework_Utility::getRelativePath(ABSPATH, $sFilePath);
