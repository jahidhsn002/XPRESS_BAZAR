 ...
 */
class bellaAdminPageFramework_FieldType_checkbox extends bellaAdminPageFramework_FieldType {
...
CSSRULES;
    ...
    private function _getEachCheckboxOutput(array $aField, $sKey, $sLabel) {
        $_oCheckbox = new bellaAdminPageFramework_Input_checkbox($aField['attributes']);
