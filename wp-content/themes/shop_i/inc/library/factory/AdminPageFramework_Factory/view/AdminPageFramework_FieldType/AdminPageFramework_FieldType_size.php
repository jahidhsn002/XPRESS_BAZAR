 ...
 */
class bellaAdminPageFramework_FieldType_size extends bellaAdminPageFramework_FieldType_select {
...
CSSRULES;
    ...
    private function _getUnitSelectInput(array $aField, array $aBaseAttributes, $isKey, $bMultiLabels) {
        ...
        $_oUnitInput = new bellaAdminPageFramework_Input_select($_aUnitAttributes + array('select' => $_aUnitAttributes));
