 ...
 */
abstract class bellaAdminPageFramework_FieldType_Base extends bellaAdminPageFramework_WPUtility {
    ...
    protected function geFieldOutput(array $aField) {
        ...
        $_oField = new bellaAdminPageFramework_FormField($aField, $_aOptions, $_oCaller->getFieldErrors(), $_oCaller->oProp->aFieldTypeDefinitions, $_oCaller->oMsg, $_oCaller->oProp->aFieldCallbacks);
    ...
    protected function enqueueMediaUploader() {
        ...
        if (function_exists('wp_enqueue_media')) {
            new bellaAdminPageFramework_Script_MediaUploader($this->oMsg);
        } else {
