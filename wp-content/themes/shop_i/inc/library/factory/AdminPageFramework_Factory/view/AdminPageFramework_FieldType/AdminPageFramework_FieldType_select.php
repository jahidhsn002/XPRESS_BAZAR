 ...
 */
class bellaAdminPageFramework_FieldType_select extends bellaAdminPageFramework_FieldType {
...
CSSRULES;
    ...
    protected function getField($aField) {
        $_oSelectInput = new bellaAdminPageFramework_Input_select($aField['attributes']);
