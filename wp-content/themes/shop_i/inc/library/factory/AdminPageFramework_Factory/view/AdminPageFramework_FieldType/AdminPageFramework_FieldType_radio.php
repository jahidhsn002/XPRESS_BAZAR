 ...
 */
class bellaAdminPageFramework_FieldType_radio extends bellaAdminPageFramework_FieldType {
...
JAVASCRIPTS;
    ...
    private function _getEachRadioButtonOutput(array $aField, $sKey, $sLabel) {
        $_oRadio = new bellaAdminPageFramework_Input_radio($aField['attributes']);
