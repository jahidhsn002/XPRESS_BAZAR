 ...
 */
abstract class bellaAdminPageFramework_FormField_Base extends bellaAdminPageFramework_FormOutput {
    public $aField = array();
    ...
    private function _loadScripts($sFieldsType = '') {
        if ('widget' === $sFieldsType && !self::$_bIsLoadedSScripts_Widget) {
            new bellaAdminPageFramework_Script_Widget;
        ...
        new bellaAdminPageFramework_Script_Utility;
        new bellaAdminPageFramework_Script_OptionStorage;
        new bellaAdminPageFramework_Script_AttributeUpdator;
        new bellaAdminPageFramework_Script_RepeatableField($this->oMsg);
        new bellaAdminPageFramework_Script_Sortable;
        new bellaAdminPageFramework_Script_RegisterCallback;
    }
