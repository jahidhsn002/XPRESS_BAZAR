 ...
 */
abstract class bellaAdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $sCapability, $sTextDomain, $sFieldsType) {
        ...
        $GLOBALS['abellaAdminPageFramework'] = isset($GLOBALS['abellaAdminPageFramework']) && is_array($GLOBALS['abellaAdminPageFramework']) ? $GLOBALS['abellaAdminPageFramework'] : array('aFieldFlags' => array());
    ...
    static public function _setLibraryData() {
        self::$_aLibraryData = array('sName' => bellaAdminPageFramework_Registry::NAME, 'sURI' => bellaAdminPageFramework_Registry::URI, 'sScriptName' => bellaAdminPageFramework_Registry::NAME, 'sLibraryName' => bellaAdminPageFramework_Registry::NAME, 'sLibraryURI' => bellaAdminPageFramework_Registry::URI, 'sPluginName' => '', 'sPluginURI' => '', 'sThemeName' => '', 'sThemeURI' => '', 'sVersion' => bellaAdminPageFramework_Registry::getVersion(), 'sDescription' => bellaAdminPageFramework_Registry::DESCRIPTION, 'sAuthor' => bellaAdminPageFramework_Registry::AUTHOR, 'sAuthorURI' => bellaAdminPageFramework_Registry::AUTHOR_URI, 'sTextDomain' => bellaAdminPageFramework_Registry::TEXT_DOMAIN, 'sDomainPath' => bellaAdminPageFramework_Registry::TEXT_DOMAIN_PATH, 'sNetwork' => '', '_sitewide' => '',);
    ...
    public function __get($sName) {
        if ('aScriptInfo' === $sName) {
            $this->sCallerPath = $this->sCallerPath ? $this->sCallerPath : bellaAdminPageFramework_Utility::getCallerScriptPath(__FILE__);
