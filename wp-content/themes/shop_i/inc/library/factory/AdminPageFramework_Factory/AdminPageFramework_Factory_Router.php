 ...
 */
abstract class bellaAdminPageFramework_Factory_Router {
    public $oProp;
    public $oDebug;
    public $oUtil;
    public $oMsg;
    ...
    protected $_aFormElementClassNameMap = array('page' => 'bellaAdminPageFramework_FormElement_Page', 'network_admin_page' => 'bellaAdminPageFramework_FormElement_Page', 'post_meta_box' => 'bellaAdminPageFramework_FormElement_Meta', 'page_meta_box' => 'bellaAdminPageFramework_FormElement', 'post_type' => 'bellaAdminPageFramework_FormElement', 'taxonomy' => 'bellaAdminPageFramework_FormElement', 'widget' => 'bellaAdminPageFramework_FormElement', 'user_meta' => 'bellaAdminPageFramework_FormElement_Meta',);
    ...
    protected $_aResourceClassNameMap = array('page' => 'bellaAdminPageFramework_Resource_Page', 'network_admin_page' => 'bellaAdminPageFramework_Resource_Page', 'post_meta_box' => 'bellaAdminPageFramework_Resource_MetaBox', 'page_meta_box' => 'bellaAdminPageFramework_Resource_MetaBox_Page', 'post_type' => 'bellaAdminPageFramework_Resource_PostType', 'taxonomy' => 'bellaAdminPageFramework_Resource_TaxonomyField', 'widget' => 'bellaAdminPageFramework_Resource_Widget', 'user_meta' => 'bellaAdminPageFramework_Resource_UserMeta',);
    ...
    protected $_aHelpPaneClassNameMap = array('page' => 'bellaAdminPageFramework_HelpPane_Page', 'network_admin_page' => 'bellaAdminPageFramework_HelpPane_Page', 'post_meta_box' => 'bellaAdminPageFramework_HelpPane_MetaBox', 'page_meta_box' => 'bellaAdminPageFramework_HelpPane_MetaBox_Page', 'post_type' => null, 'taxonomy' => 'bellaAdminPageFramework_HelpPane_TaxonomyField', 'widget' => 'bellaAdminPageFramework_HelpPane_Widget', 'user_meta' => 'bellaAdminPageFramework_HelpPane_UserMeta',);
    ...
    protected $_aLinkClassNameMap = array('page' => 'bellaAdminPageFramework_Link_Page', 'network_admin_page' => 'bellaAdminPageFramework_Link_NetworkAdmin', 'post_meta_box' => null, 'page_meta_box' => null, 'post_type' => 'bellaAdminPageFramework_Link_PostType', 'taxonomy' => null, 'widget' => null, 'user_meta' => null,);
    ...
    protected $_aPageLoadClassNameMap = array('page' => 'bellaAdminPageFramework_PageLoadInfo_Page', 'network_admin_page' => 'bellaAdminPageFramework_PageLoadInfo_NetworkAdminPage', 'post_meta_box' => null, 'page_meta_box' => null, 'post_type' => 'bellaAdminPageFramework_PageLoadInfo_PostType', 'taxonomy' => null, 'widget' => null, 'user_meta' => null,);
    ...
    public function _replyTpSetAndGetInstance_oUtil() {
        $this->oUtil = new bellaAdminPageFramework_WPUtility;
        return $this->oUtil;
    }
    public function _replyTpSetAndGetInstance_oDebug() {
        $this->oDebug = new bellaAdminPageFramework_Debug;
        return $this->oDebug;
    }
    public function _replyTpSetAndGetInstance_oMsg() {
        $this->oMsg = bellaAdminPageFramework_Message::getInstance($this->oProp->sTextDomain);
        return $this->oMsg;
    }
