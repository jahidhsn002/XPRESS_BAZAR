			...
			<div class="kakina-child-theme-details">
				<?php if ( 'Alpha Store' != $current_theme['Name'] ) { ?>
					<div class="theme-details">
						...
						<a href="<?php echo esc_url( wp_nonce_url( self_admin_url( 'update.php?action=install-theme&theme=alpha-store' ), 'install-theme_alpha-store' ) ); ?>" class="button button-primary install right"><?php printf( __( 'Install %s now', 'kakina' ), '<span class="screen-reader-text">Alpha Store</span>' ); ?></a>
