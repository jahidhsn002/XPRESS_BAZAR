...
add_action( 'customize_controls_print_footer_scripts', 'kakina_pro_banner' );

function kakina_pro_banner() {
	echo '<a href="' . esc_url( 'http://themes4wp.com/product/kakina-pro/' ) . '" id="pro-banner" style="display: none; margin-top: 10px; background: #192429;" target="_blank"><img src="' . get_template_directory_uri() . '/img/kakina-pro.jpg" /></a>';
...
if ( !function_exists( 'kakina_social_links' ) ) :
	...
	function kakina_social_links() {
		$twp_social_links	 = array( 'twp_social_facebook'	 => __( 'Facebook', 'kakina' ),
